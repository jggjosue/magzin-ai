...
export default function Home() {
  ...
  return (
      <main>
            ...
            <div className="container px-4 py-8">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  {
                    /**
                     <div className="h-8 w-8 rounded-lg bg-white flex items-center justify-center font-bold"></div>
                     */
                  }
              ...
              <div className="mx-auto mt-16 max-w-3xl text-center" id="about">
                <h1 className="text-4xl font-bold leading-tight tracking-tighter text-white sm:text-5xl md:text-6xl lg:text-7xl">
                  Transform Your Instagram Engagement with Magzin
                </h1>

                <p className="mt-6 text-lg text-blue-200">
                  Magzin revolutionizes how you connect with your audience on
        ...
        <section className="container w-full py-12 md:py-24 lg:py-4 bg-background">
          <div className="container w-full py-12 md:py-24 lg:py-4">
            <p className="text-muted-foreground text-center">
              <Link href="/privacy" target="_blank">Privacy Policy</Link> | <Link href="/terms" target="_blank">Terms of Service</Link>
            </p>
            <p className="text-muted-foreground flex flex-col items-center">
              @ 2024 Magzin LLC. All Rights reserved.
            </p>
          </div>
        </section>
      </main>
